...
function Colors() {
    const colors = [
        { id: 'blue', name: 'Titânio Azul', image: '/img/iphone-blue.jpg', colorsClass: 'bg-blue-500' },
        { id: 'silver', name: 'Titânio Natural', image: '/img/iphone-silver.jpg', colorsClass: 'bg-gray-300' },
        { id: 'orange', name: 'Titânio Laranja', image: '/img/iphone-orange.jpg', colorsClass: 'bg-orange-500' }
    ];
                    ...
                    <div className="flex justify-center items-center gap-4">
                        {colors.map(color => (
                            <button
                                ...
                                <div className={`w-16 h-16 rounded-full border-4 ${color.colorsClass} ${selectedColor === color.id ? 'border-white' : 'border-gray-600'}`}></div>
                            </button>
                        ))}
                    </div>
